namespace NethereumUtilLibraryIntroduce_4_2_9_Example.Demo.DependOn
{
    ...
    public class KeccakDigest
    {
        ...
        /// <summary>
        /// 默認建構函式，創建一個 288 位元長度的 Keccak 摘要器
        /// </summary>
        public KeccakDigest()
            : this(288)
        {
        ...
        /// <summary>
        /// 複製建構函式，從現有的 KeccakDigest 創建新實例
        /// </summary>
        /// <param name="source">要複製的來源 KeccakDigest 物件</param>
        ...
        /// 更新摘要器狀態，吸收單個位元組
        /// </summary>
        /// <param name="input">要處理的位元組</param>
        ...
        /// <summary>
        /// 完成雜湊計算，包括處理部分位元組，並將結果寫入輸出陣列
        /// </summary>
        /// <param name="output">輸出位元組陣列</param>
        /// <param name="outOff">輸出偏移量</param>
        /// <param name="partialByte">包含部分位元的位元組</param>
        /// <param name="partialBits">部分位元組中有效位元數</param>
        /// <returns>寫入的位元組數</returns>
        ...
        /// 獲取每次處理的位元組數
        /// </summary>
        /// <returns>每次處理的位元組數</returns>
        public virtual int GetByteLength()
        {
            return rate >> 3;  // 將位元數轉換為位元組數
        }
        ...
        private void InitSponge(int rate)
        {
            ...
            Arrays.Fill(dataQueue, 0);            // 清空資料佇列
            bitsInQueue = 0;
            squeezing = false;
        ...
        /// 吸收非完整位元組的位元
        /// </summary>
        /// <param name="data">包含位元的位元組</param>
        /// <param name="bits">要吸收的位元數 (1-7)</param>
